...
async def import_terminology(background_tasks: BackgroundTasks, terminology_id: str, model: str = "nomic-embed-text"):
...
async def import_snomed_ct(background_tasks: BackgroundTasks, model: str = "nomic-embed-text"):
...
async def import_jsonl(background_tasks: BackgroundTasks, object_type: ObjectSchema, file: UploadFile):
